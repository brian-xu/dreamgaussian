...
parser.add_argument(
    "--out", default="logs", type=str, help="Directory where obj files will be saved"
)
parser.add_argument(
    "--video-out",
    default="videos",
...
parser.add_argument(
    ...
    default="configs",
    type=str,
    help="Path to config directory, which contains image.yaml",
)
...
for file in files:
    ...
    os.system(
        f"python -m kiui.render {mesh_path} "
